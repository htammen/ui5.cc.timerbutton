...
/**
 * Initialization Code and shared classes of library vwlaekh.portal.mitglieder.controls.
 */

// delegate further initialization of this library to the Core
// Hint: sap.ui.getCore() must still be used here to support preload with sync bootstrap!
sap.ui.getCore().initLibrary({
	name: "vwlaekh.portal.mitglieder.controls",
	version: "${version}",
	dependencies: [
		// keep in sync with the ui5.yaml and .library files
		"sap.ui.core"
	],
	types: ["vwlaekh.portal.mitglieder.controls.ExampleColor"],
	interfaces: [],
	controls: ["vwlaekh.portal.mitglieder.controls.Example"],
	elements: [],
...
const thisLib: { [key: string]: unknown } = ObjectPath.get("vwlaekh.portal.mitglieder.controls") as {
	[key: string]: unknown;
};
